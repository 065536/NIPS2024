...
class Base_Agent(object):
    ...
    def conduct_action(self, action,option=None):
        """Conducts an action in the environment"""
        self.next_state, self.reward, self.done, _ = self.environment.step(action,option=option,render = self.config.render)
