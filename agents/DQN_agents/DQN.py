...
class DQN(Base_Agent):
    ...
    def __init__(self, config):
        ...
        self.q_network_local = self.create_NN(input_dim=self.state_size*config.magic_number, output_dim=config.output_dim_)
    ...
    def pick_action(self, state=None, mask=None):
